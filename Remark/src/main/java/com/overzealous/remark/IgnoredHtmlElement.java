...
/**
 * Provides a standard class to note which HTML elements should be left in the
 * final output.
 * 
...
public class IgnoredHtmlElement {
   ...
   /**
    * Create a new IgnoredHtmlElement. The tagname may also be referred to as
    * the NodeName.
    *
    * @param tagName
    *           The tag name, such as {@code DIV}, case-insensitive.
    */
    ...
    * 
    * @param attributes
    *           The attribute names that are to be allowed.
    */
