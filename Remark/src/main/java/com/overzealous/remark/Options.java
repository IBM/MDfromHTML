...
public class Options implements Cloneable {
   ...
   public enum Tables {
          ...
          * 
          * @see <a href=
          *      "http://fletcher.github.com/peg-multimarkdown/#tables">MultiMarkdown
          *      Tables</a>
          */
      ...
      /**
       * True if the table is to be converted to plain text. This is true if the
       * result is a Markdown table or a code block.
       * 
       * @return true or false
       */
   ...
   public enum InWordEmphasis {
         /**
          * Uses the default mode, which allows in-word emphasis. Because Remark
          * only uses asterisks for spacing ({@code '*'}), this mode works with
          * parsers that disable in-word underscores ({@code '_'}) but not
          * in-word asterisks.
          */
         NORMAL(true, false),
         /**
          ...
          *
          * For example, {@code My<em>Example</em>Word} becomes
          * {@code My *Example* Word}. This will actually render as
          * {@code My <em>Example</em> Word}.
          */
          ...
          *
          * This means that {@code My<em>Example</em>Word} becomes
          * {@code MyExampleWord}.
          *
          */
   ...
   /**
    * If true, relative links are preserved. <strong>You must still provide a
    * baseURI!</strong>
    * <p>
   ...
   /**
    * If true, replace all smart quote HTML entities (e.g: {@code &ldquo;} with
    * simplified characters (e.g: {@code "}).
    */
   public boolean reverseHtmlSmartQuotes = false;

   /**
    * If true, replace all smart quote unicode characters (e.g: &#0147) with
    * simplified characters (e.g: {@code "}).
    */
    ...
    * }, {@code 
    * <dt>}, and {@code 
    * <dd>}) are converted into
    * <a href="http://michelf.com/projects/php-markdown/extra/#def-list">PHP
    * Markdown Extra style definition lists</a>.
    */
   public boolean definitionLists = false;

   /**
    * If true, enable remarking abbreviations. When enabled, {@code <abbr>} tags
    * are converted into
    * <a href="http://michelf.com/projects/php-markdown/extra/#abbr">PHP
    * Markdown Extra style abbreviations</a>.
    */
    ...
    *
    * Example: <blockquote>{@code <a href=
    * "http://www.example.com">http://www.example.com</a>}</blockquote> becomes
    ...
    * <a href="http://michelf.com/projects/php-markdown/extra/#header-id">PHP
    * Markdown Extra style header IDs</a>.
    */
    ...
    * links with <strong>bold</strong> and <em>italics</em> in the label for an
    * anchor.
    *
    ...
    *
    * @see <a href="https://github.com/sirthias/pegdown/issues/34">Pegdown Issue
    *      #34</a>
    */
