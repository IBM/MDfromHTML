...
public class MarkdownTable {
    ...
    */
   public void renderTable(PrintWriter output, boolean allowColspan,
    ...
    */
   private void renderRows(PrintWriter output,
   ...
   private void renderHeaderSeparator(PrintWriter output,
      boolean renderAsCode) {
      println(output);
