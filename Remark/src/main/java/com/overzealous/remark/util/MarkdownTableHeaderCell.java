...
/**
 * This class contains the contents of a table cell. It's used to help keep
 * track of information about the table so the final table can be built with
 * clean formatting.
 *
...
public class MarkdownTableHeaderCell {
   ...
   /**
    * Sets the contents of this cell. If the contents contain any linebreaks,
    * they will be replaced with spaces.
    *
    * @param contents
    *           The new cell contents
    */
   public void setHeaderContents(String contents) {
      if (contents == null) {
         contents = "";
      }
      // We don't allow linebreaks in a table cell
      // wnm3 out for better text processing
   ...
   /**
    * Sets the number of columns this cell spans. If the colspan is less than 1,
    * it is set to 1.
    * 
    * @param colspan
    *           The new colspan
   ...
   /**
    * Returns the number of characters needed to show this column. It adds two
    * to the content width, so there is padding around the content.
    * 
   ...
   public String toString() {
      return "MarkdownTableCell{" + "colspan=" + colspan + ", alignment="
         + alignment + ", contents='" + contents + '\'' + '}';
   }
