...
public class StringUtils {
    ...
    * @return Padded string
    */
   public static String align(String s, int width, char paddingChar,
      int alignment) {
      if (s.length() < width) {
    ...
    *           means right
    */
   public static void align(PrintWriter output, String s, int width,
      int alignment) {
   ...
   /**
    * Duplicates the given string {@code count} times. If {@code count} is less
    * than or equal to 0, the empty string is returned.
    * 
    * @param s
    *           String to duplicate
    * @param count
   ...
   /**
    * Duplicates the given character {@code count} times to the Writer. If
    * {@code count} is less than or equal to 0, this is a no-op.
    * 
    * @param output
    *           Writer to receive duplicated results
    * @param c
    *           Character to duplicate
    * @param count
    *           Number of times to duplicate
   ...
   /**
    * Duplicates the given string {@code count} times to the Writer. If
    * {@code count} is less than or equal to 0, this is a no-op.
    * 
    * @param output
    *           Writer to receive duplicated results
   ...
   public static String prependEachLine(String s, String prependWith) {
      StringWriter sw = new StringWriter(
         s.length() + (prependWith.length() * 20));
    ...
    *
    * @param output
    *           The writer to receive the modified string.
    * @param s
    *           The input string.
    * @param prependWith
    *           The string to prepend to each line.
    */
   public static void prependEachLine(PrintWriter output, String s,
      String prependWith) {
      if (s.length() == 0) {
         return;
      }
