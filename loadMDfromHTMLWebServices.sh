...
then
   ...
   docker run -v /store/WAALogs:/logs -v /store/WAAData/mdfromhtmlsvcs/properties/:/opt/ol/wlp/output/defaultServer/properties -v /store/WAAData/mdfromhtmlsvcs/data/:/opt/ol/wlp/output/defaultServer/data --publish 9081:9081 --detach --name mdfromhtmlsvcs mdfromhtmlwebservices
fi
sleep 10
