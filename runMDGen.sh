#! /bin/bash
jar -uvf ./MarkdownGenerator-1.0.6-jar-with-dependencies.jar HTML_Filters.json
java -cp "./MarkdownGenerator-1.0.6-jar-with-dependencies.jar" com.mdfromhtml.markdown.transform.GetMarkdownFromHTML "./src/test/resources" "./src/test/resources"
